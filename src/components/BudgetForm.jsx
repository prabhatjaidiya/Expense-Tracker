...
const BudgetForm = () => {
    ...
    return (
        <div className="bg-white rounded-xl mt-2 shadow-md border p-6">
            <h2 className="text-xl font-semibold mb-5 ml-12">
                Monthly Budget
            </h2>
            <div className="flex justify-evenly">
                <form onSubmit={handleSubmit} className="space-y-4 mr-12">
                    ...
                    <div className="flex gap-12">
                        ...
                        <button
                            type="button"
                            onClick={handleReset}
                            className="bg-red-500 text-white py-3 px-5 rounded-xl hover:bg-red-600 transition"
                        >
                            Reset Budget
                        </button>
                    </div>
                ...
                <div className="border-t space-y-4">
                    <p className="text-gray-500 text-xl">Current Budget</p>
